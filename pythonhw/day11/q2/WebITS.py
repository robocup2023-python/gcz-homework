...
class get_result(object):
    def __init__(self,host):
        ...
        self.Secret = "ZDA4Y2RlNjBkNGE2NTE4OWY3ODVjMzg3"
        # 接口APIKey（到控制台机器翻译服务页面获取）
        self.APIKey= "c4b90355cf3861a672e93838a5da1882"
...
def client_request(req):
    gClass.Text = req
def get_res():
    res = gClass.call_url()['data']['result']['trans_result']
    return res['src']+" 翻译的结果是"+res['dst']
